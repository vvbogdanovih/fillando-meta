...
| [Plan-0005](plan-0005-catalog-target-state.md) | **Цільовий стан каталогу — трекер приймання** | In Progress — блоки C і D закриті в коді (`dev`); лишилося те, що впирається у власника або в реліз |
