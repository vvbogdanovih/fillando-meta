...
| A4 | Міграції 3a–3f на проді за порядком; 3f лише після A3 | власник | Блок B |
...
|---|---|---|---|
| B1 | Написати H1, title, meta, вступ, SEO-текст і FAQ для 13 лендінгів і опублікувати | L | усі 14 адрес віддають 404; головна SEO-обіцянка не працює |
| B2 | Розібрати 49 нерозпізнаних написань кольору → синоніми → перепрогін 3d і 3f | M | ~16% варіантів невидимі для swatch-фільтра, 5 товарів покриті на 0% |
| B3 | Винести рефіл FL-000253 в окремий товар, проставити «Котушка в комплекті = Ні (рефіл)» | M | екран 4 неможливий; `/filament/refill` матчить 0 товарів |
| B4 | Kingroon PETG (CoPET) 3 кг: проставити `Матеріал = PETG`, полагодити `category_id` (рядок замість ObjectId) | S | товар випадає з усіх чотирьох нових фільтрів і з усіх лендінгів |
| B5 | Розвести дублікати «Candy» FL-000157 / FL-000162 | S | товар Kingroon PLA Silk Rainbow неможливо перейменувати (409) |
| B6 | Прибрати дубльований `finish` на двох товарах | S | значення невидиме й невиправне у формі |
...
| 5 | Рефіл: розділяємо FL-000253 в окремий товар? Без цього екран 4 недосяжний | B3 |
